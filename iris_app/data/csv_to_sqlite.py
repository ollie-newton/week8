...
# Write the data to a table in the sqlite database (data/iris.db). SQLite has a rowid by default so we don't need to explicitly add a primary key.
iris.to_sql("iris", engine, if_exists="append")
